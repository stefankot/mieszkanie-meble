...
assert.equal(navigationActionForKey({code:'ArrowUp',shiftKey:true}),'patrzGora');
assert.equal(navigationActionForKey({code:'ArrowDown',shiftKey:true}),'patrzDol');
...
assert.equal(navigationActionForKey({code:'Equal',shiftKey:false}),'kameraGora');
assert.equal(navigationActionForKey({code:'Equal',shiftKey:true}),'kameraGora');
assert.equal(navigationActionForKey({code:'Minus',shiftKey:false}),'kameraDol');
assert.equal(navigationActionForKey({code:'Minus',shiftKey:true}),'kameraDol');
