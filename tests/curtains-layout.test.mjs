...
import {wyznaczScianyZaslon, wysokoscZaslony} from '../renderery/webgpu/uklad-zaslon.mjs';
...
assert.equal(APARTMENT_DATA.height,260);
assert.equal(wysokoscZaslony({APARTMENT:{height:250}}),260);
assert.equal(wysokoscZaslony({APARTMENT:{height:275}}),275);
