# Regał w pokoju z łóżkiem — prompt do istniejącej rozmowy

Wklej poniższą treść w całości do rozmowy o tym meblu, z włączoną wtyczką GitHub.

---

Identyfikator mebla w tej rozmowie: `regal-przy-lozku`. Nazwa: Regał w pokoju z łóżkiem. Nie twórz nowego identyfikatora i nie edytuj innych mebli.
