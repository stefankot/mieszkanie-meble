# Regał w kuchni — prompt do istniejącej rozmowy

Wklej poniższą treść w całości do rozmowy o tym meblu, z włączoną wtyczką GitHub.

---

Identyfikator mebla w tej rozmowie: `regal-kuchnia`. Nazwa: Regał w kuchni. Nie twórz nowego identyfikatora i nie edytuj innych mebli.
