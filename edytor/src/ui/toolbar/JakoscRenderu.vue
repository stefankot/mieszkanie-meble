...
import { opcjeKontrolki, ustawKontrolke, wartoscKontrolki } from '@/silnik/most'
...
/* Jakość obrazu i renderu (dawna zakładka Effect) — pływające okno z ikony na pasku.
   Image: działa (most do starego panelu renderera). Global light i Cinematic Motion: makieta
   (docelowo węzły TSL three: TRAA, MotionBlur, DepthOfFieldNode, FilmNode, Lut3DNode). */
