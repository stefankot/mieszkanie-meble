...
const guzik = 'flex h-5 items-center gap-1.5 rounded-[3px] bg-[#16181c]/90 px-2 text-[10px] text-text shadow-lg hover:bg-[#23262c]'
</script>

<template>
  <div class="absolute left-3 top-3 z-20 flex gap-1.5">
