# Łóżko pod oknem — prompt do istniejącej rozmowy

Wklej poniższą treść w całości do rozmowy o tym meblu, z włączoną wtyczką GitHub.

---

Identyfikator mebla w tej rozmowie: `lozko`. Nazwa: Łóżko pod oknem. Nie twórz nowego identyfikatora i nie edytuj innych mebli.
